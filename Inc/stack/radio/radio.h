...
typedef struct
{
    ...
    void ( *TxTimeout )( void );
    /*!
     * \brief Valid Sync Word Detected callback prototype.
     */
    void ( *SyncWordValid )( void );
    /*!
    ...
    /*!
     * \brief Valid Preamble Detected callback prototype.
     */
...
struct Radio_s
{
     ...
     * \param [IN] bandwidth    Sets the bandwidth (LoRa only)
     *                          FSK : >= 2600 and <= 250000 Hz
     *                          LoRa: see RadioLoRaBandwidths_t
     * \param [IN] datarate     Sets the Datarate
     *                          FSK : 600..300000 bits/s
     *                          LoRa: [6: 64, 7: 128, 8: 256, 9: 512,
     *                                10: 1024, 11: 2048, 12: 4096  chips]
     ...
     */
    uint32_t  ( *TimeOnAir )( RadioModems_t modem, uint8_t pktLen, uint32_t fdev,
                              uint32_t bandwidth, uint32_t datarate,
                              uint8_t coderate, uint16_t preambleLen,
     ...
     * \param [OUT] snr         SNR
     */
    void    ( *ReadRxData )( uint8_t* buff, uint8_t size, uint8_t* datasize, uint8_t* rssi, int8_t* snr );
    /*!
     ...
     */
    uint8_t ( *Rssi )( RadioModems_t modem );
    /*!
...
//    void    ( *ReadBuffer )( uint16_t addr, uint8_t *buffer, uint8_t size );
     ...
     * \param [IN] size   Length to be written
     */
